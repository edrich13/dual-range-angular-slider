import * as DualRange from 'dualrange';
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => DualRangeComponent),
      multi: true
    }
  ]
})
export class DualRangeComponent implements ControlValueAccessor, OnInit, OnChanges {
...
@NgModule({
  imports: [],
  exports: [DualRangeComponent],
  declarations: [DualRangeComponent],
})
export class DualRangeModule { }